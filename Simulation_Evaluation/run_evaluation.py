...
class SimulationEvaluationSuite:
    ...
    def run_all_suites(self):
        """Executes all 4 quantitative simulation suites consecutively."""
        print("==================================================")
        ...
        for i in range(1, 101):
            ...
            if phase == 0:
                ...
                try:
                    ...
                    res = self.executor.execute_command(validated)
    ...
    def save_metrics(self, results):
        """Saves generated simulation stats to evaluation_metrics.json."""
