...
class SimulationTelemetryEngine:
    ...
    def _plot_figure_6_1(self):
        ...
        box = ax.boxplot(
            ...
            tick_labels=["aarch64 (Raspberry Pi 4)", "x86_64 (Gateway)"],
            patch_artist=True,
            widths=0.45,
        ...
        ax.set_title(
            "Figure 6.1: Edge Sync Latency Distribution (350 Runs)",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_2(self):
        ...
        ax.set_title(
            "Figure 6.2: Legacy Maintenance Downtime vs. Automated OTA Pipeline",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
        ...
        ax.text(
            avg_val * 1.2,
            0,
            f"{avg_val:.4f} seconds active downtime\n({(2700.0 - avg_val) / 2700.0 * 100:.4f}% downtime reduction)",
            va="center",
            ha="left",
            fontsize=8.5,
            fontweight="bold",
    ...
    def _plot_figure_6_3(self):
        ...
        ax.set_title(
            "Figure 6.3: Security Defense: Legacy System vs. Secure Custom Pipeline",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_4(self):
        ...
        ax.set_xscale("log")
        ax.set_title(
            "Figure 6.4: Connection Recovery vs. Outage Duration (350 Outages)",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_5(self):
        ...
        ax.axvline(
            self.df4["Total RTT Latency (ms)"].median(),
            color=self.colors["warning"],
            linestyle=":",
            linewidth=1.5,
            label=f"Median RTT ({self.df4['Total RTT Latency (ms)'].median():.2f} ms)",
        )

        ax.set_title(
            "Figure 6.5: Frequency Distribution of RTT Telemetry (350 Runs)",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_6(self):
        ...
        ax.set_title(
            "Figure 6.6: Cumulative Financial ROI: Legacy vs. Automated Pipeline",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_7(self):
        ...
        ax.set_title(
            "Figure 6.7: Cumulative Fleet Savings: Network Self-Healing Reconnections",
            fontsize=11,
            fontweight="bold",
            pad=15,
        )
    ...
    def _plot_figure_6_8(self):
        ...
        ax.set_yticks([1, 2])
        ax.set_yticklabels(
            ["x86_64 (Gateway)", "aarch64 (Raspberry Pi 4)"],
            fontsize=9.5,
            fontweight="bold",
        )
        ...
        ax.set_title(
            "Figure 6.8: CI/CD Build Time Distribution & Disjoint IQR Ranges (350 Runs)",
            fontsize=11.5,
            fontweight="bold",
            pad=20,
            color=self.colors["dark"],
